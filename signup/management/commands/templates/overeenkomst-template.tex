...
\thispagestyle{empty}
\pagestyle{empty}
\textbf{Stichting OpenGeo}, gevestigd en kantoorhoudende aan de Oude Trambaan 7 te Leidschendam, ingeschreven bij de Kamer van Koophandel onder nummer 20147376, te dezer zake rechtsgeldig vertegenwoordigd door \textbf{Stefan de Konink, bestuurder}, hierna te noemen ``loket'';
\begin{center}
en\\
\end{center}
...
\item Brongegevens aan afnemers beschikbaar worden gesteld onder een CC0 vrijwaring. De data valt in het publiek domein er is geen auteurs- of databankenrecht van toepassing;
\item Brongegevens aan afnemers worden verstrekt door een loket;
\item Levering van brongegevens aan een loket geschiedt op basis van afspraken tussen overheden en vervoerders;
...
\item Tegen een gebruiker/afnemer die misbruik maakt van brongegevens kan door de leverancier van de brongegevens aangifte gedaan worden wegens smaad en aansprakelijk gesteld worden voor de schade die uit het misbruik voortvloeit;
\item Een loket afnemers (mogelijk) een vergoeding voor verstrekking van brongegevens in rekening kan brengen;
\item Het monitoren van de concessie-uitvoering geschiedt op basis van afspraken tussen de OV-autoriteit (concessieverlener) en de vervoerder (concessiehouder).
\end{enumerate}
...
\hline
	Brongegevens                & Gegevens zoals deze gedefinieerd zijn in \href{https://www.dova.nu/document/publicatiedocument-ndov-bijlage-1}{de (dynamische) bijlage 1 van dit document}. \\
\hline
...
\begin{enumerate}
   \item Een loket verleent aan een afnemer, vanaf de datum van ondertekening van deze leveringsovereenkomst, een niet-exclusieve licentie voor het gebruik van brongegevens. Afnemer mag brongegevens, al dan niet in bewerkte vorm, doorleveren aan derde partijen onder een CC0 vrijwaring.
   \item Een loket verstrekt brongegevens.
...
\begin{enumerate}
   \item De verstrekkingskosten worden jaarlijks bepaald.\\ \textit{Peildatum 1 januari 2025: Er wordt \textbf{geen vergoeding} gerekend in dit kalenderjaar.}
   ...
   \item De vergoeding voor verstrekking van brongegevens per afnemer bedraagt ten hoogste 1000 euro per kalenderjaar exclusief BTW.
   \item De vergoeding wordt per maand bepaald en gefactureerd naar gebruik van de afnemer, de betalingstermijn is 30 dagen na ontvangst van de factuur.
...
\begin{enumerate}
   \item Afnemer kan deze leveringsovereenkomst op ieder moment, zonder opgave van redenen, schriftelijk opzeggen.
...
\begin{enumerate}
   \item Een loket kan deze leveringsovereenkomst met onmiddellijke ingang beëindigen door middel van een schriftelijke verklaring, indien afnemer ook na schriftelijke aanmaning, binnen een redelijke termijn, in strijd handelt met één van de artikelen van deze gebruikssovereenkomst.
