...
HELPDESK_FILTER_LABEL_TO_QUEUE = getattr(settings, 'HELPDESK_FILTER_LABEL_TO_QUEUE', False)

HELPDESK_SEND_SUBMITTER_EMAIL = getattr(settings, 'HELPDESK_SEND_SUBMITTER_EMAIL', True)

''' Publish options '''
HELPDESK_ATTACHMENT_PUBLISH_PATH = getattr(settings, 'HELPDESK_ATTACHMENT_PUBLISH_PATH', settings.MEDIA_ROOT)
