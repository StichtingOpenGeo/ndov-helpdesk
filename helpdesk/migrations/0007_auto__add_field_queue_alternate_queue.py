...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Queue.alternate_queue'
        db.add_column('helpdesk_queue', 'alternate_queue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['helpdesk.Queue'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Queue.alternate_queue'
        db.delete_column('helpdesk_queue', 'alternate_queue_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 9, 16, 50, 0, 698433)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 9, 16, 50, 0, 698342)'}),
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 9, 16, 50, 0, 431287)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'helpdesk.queue': {
            ...
            'alternate_queue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['helpdesk.Queue']", 'null': 'True', 'blank': 'True'}),
