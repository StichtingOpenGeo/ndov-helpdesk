...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queue.allow_public_access'
        db.add_column('helpdesk_queue', 'allow_public_access',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queue.allow_public_access'
        db.delete_column('helpdesk_queue', 'allow_public_access')
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'helpdesk.queue': {
            ...
            'allow_public_access': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
